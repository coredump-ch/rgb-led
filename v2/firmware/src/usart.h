...
/**
 * Takes the defined BAUD and F_CPU, calculates the bit-clock multiplier, and
 * configures the hardware USART
 */
void initUSART(void);

/* Blocking transmit and receive functions. When you call receiveByte() your
will hang until data comes through. We'll improve on this later. */
